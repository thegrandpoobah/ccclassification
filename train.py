...
VERIFY_FACTOR = 8 # 80% of input should be treated as training, 20% should be treated as verification
...
model = fasttext.train_supervised(input="/tmp/cctransactions.train", epoch=50, lr=0.8, wordNgrams=2)
